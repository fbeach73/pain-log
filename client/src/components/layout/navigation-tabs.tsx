  ...
  return (
    <div className="bg-white border-b">
      <div className="px-4 sm:px-6 md:px-8 overflow-x-auto">
        <nav className="flex -mb-px space-x-4 md:space-x-6 overflow-x-auto scrollbar-hide whitespace-nowrap py-1 min-w-max">
          {navItems.map((item) => (
            <button
              key={item.path}
              ...
              className={cn(
                "whitespace-nowrap py-3 px-3 border-b-2 font-medium text-sm flex-shrink-0 transition-colors",
                location === item.path
