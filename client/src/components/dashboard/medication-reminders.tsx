...
import { Check, Clock, Settings, Plus } from "lucide-react";
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Button variant="ghost" size="sm" className="text-primary-600 hover:text-primary-700 flex items-center">
          Manage
                  ...
                  <div className="flex">
                    {(medication.timeOfDay as string[]).map((time, index) => (
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className={`text-xs rounded-full mr-2 ${
